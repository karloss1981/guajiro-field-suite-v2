            ...
            <>
              ...
              {mode==='reason'&&(
                <div style={{marginTop:10,background:C.card2,borderRadius:12,padding:"14px",border:"1px solid #162e58"}}>
                  ...
                  {notePanel}
                  <div style={{display:"flex",gap:8}}>
                    <button onClick={confirmNotDone} disabled={!reason||saving}
                      style={{flex:1,background:reason?C.red:C.muted,border:"none",borderRadius:8,padding:"11px",color:reason?"#fff":C.dim,fontWeight:700,cursor:reason?"pointer":"default",fontSize:13}}>
                      {saving?t.savingLabel:t.confirmBtn}
                    </button>
